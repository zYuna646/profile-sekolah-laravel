        ...
        <div class="container-fluid" style="padding-left: 80px; padding-right: 80px;">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
                <ul class="navbar-nav gap-4">
                    <li class="nav-item">
                        <a class="nav-link nav-active fw-bold" aria-current="page" href="#">Home</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="#">Jumlah Siswa</a></li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link fw-bold" href="#">Galeri Kegiatan</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container-fluid p-0 mt-3">
        <div class="row">
            <div class="col-lg-8 p-4" style="background-color: #D37E00; border-radius: 0px 50px 50px 0px;">
                <div>
                    <div class=" ">
                        <h3 class="text-light">Sambutan Kepala Sekolah</h2>
