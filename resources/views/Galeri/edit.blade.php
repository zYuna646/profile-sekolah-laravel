        ...
        <div class="card-body p-4">
            ...
            <form method="post" action="{{route('dashboard.kompetensi.update', $data->id)}}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="keterangan" rows="5" value="{{$data->keterangan}}"></textarea>
                    </div>
                    <fieldset class="form-group">
                        <label for="inputPassword3" class="col-sm-2 col-form-label ">Foto Kegiatan</label>
                        <div class="col-sm-10 my-2">
                            <input type="file" class="form-control-file" name="foto_galeri" value="{{$data->foto_galeri}}">
                        </div>
                </div>
                </fieldset>
                <div class="row">
