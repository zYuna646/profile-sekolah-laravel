      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.html" class="text-nowrap logo-img row">
            <div class="col">
                <img src="{{asset('assets')}}/img/SMAN MODEL LOGO.png" style="width:30px"/>
            </div>
            <div class="col">
                <h5 class="fw-bolder">Sistem Informasi <br>SMK Model Gorontalo</h5>
            </div>
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link {{ (request()->is('dashboard/kompetensi*') ? 'active' : '') }}" href="{{ route('dashboard.kompetensi') }}" aria-expanded="false">
                <span>
          ...
          <div class="unlimited-access hide-menu bg-light-primary position-relative mb-7 mt-5 rounded">
            <div class="d-flex">
              ...
              <div class="unlimited-access-img">
                <img src="assetsDashboard/images/backgrounds/rocket.png" alt="" class="img-fluid">
              </div>
            </div>
          </div>
        </nav>
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="py-6 px-6 text-center">
          <p class="mb-0 fs-4">Design and Developed by Dhani Ardiyanto Syahdila</p>
        </div>
      </div>
    </div>
  </div>
